            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <button 
                  ...
                  className="bg-print-orange hover:bg-print-orange-dark text-white focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 px-6 py-2 rounded-lg transition-colors"
                >
                  צור קשר
                </button>
              </div>
            ...
            <div className="order-1 lg:order-2 bg-gray-50 p-4 sm:p-6 lg:p-8 rounded-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6" noValidate>
                ...
                <button
                  ...
                  className="w-full bg-print-orange hover:bg-print-orange-dark text-white px-6 py-4 text-base sm:text-lg rounded-lg font-semibold focus:ring-4 focus:ring-blue-200 transition-colors duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
